...
# Load the datasets
Diabetes_df = pd.read_csv("C:\\Users\\Shivangi\\OneDrive\\Desktop\\Shivangi Singh\\HealthMate Smart Disease Predictor and Medical Assistant\\Data and EDA\\diabetes.csv")
...
print("\n'SkinThickness' column has been dropped.")

Diabetes_df.drop('DiabetesPedigreeFunction', axis=1, inplace=True)
print("\n'DiabetesPedigreeFunction' column has been dropped.")
